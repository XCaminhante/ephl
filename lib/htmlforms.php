<?php
//@+leo-ver=5-thin
//@+node:caminhante.20210904222845.9: * @file htmlforms.php
//@@first
//@@language php
//@@nocolor
...
//@+others
//@+node:caminhante.20210905134043.1: ** DefaultForm
...
<form method="<?php echo html($this->method)?>" action="<?php echo html($this->action)?>" enctype="<?php echo html($this->enctype)?>"<?php if (!empty($this->cssClass)): ?> class="<?php echo html($this->cssClass)?>"<?php endif; ?>>
  ...
  <ul class="actions">
    <?php foreach ($this->actions as $action):
      $cssClass = isset($action->cssClass)? $action->cssClass: preg_replace('/[^a-zA-Z]/', '', preg_replace('/([^a-zA-Z]|^)([a-zA-Z])/', '\'$1\'.strtoupper(\'$2\')', $action->getName())); ?>
...
//@+node:caminhante.20210905134049.1: ** FormFieldset
...
//@+node:caminhante.20210905134052.1: ** DefaultFormAction
...
//@+node:caminhante.20210905134055.1: ** FormActionLink
...
//@+node:caminhante.20210905134058.1: ** FormFieldHtml
...
//@+node:caminhante.20210905134112.1: ** DefaultFormField
abstract class DefaultFormField extends FormField {
  ...
  public $tabindex = null;
  //@+others
  //@+node:caminhante.20210905134425.1: *3* getCssClass
  public function getCssClass() {
    return !is_null($this->cssClass)? $this->cssClass:
      preg_replace('/[^a-zA-Z0-9]/', '', preg_replace('/([^a-zA-Z]|^)([a-zA-Z0-9])/', '\'$1\'.strtoupper(\'$2\')', $this->name));
  }
  //@+node:caminhante.20210905134427.1: *3* getLabel
  public function getLabel() {
    return is_null($this->label)? $this->name: $this->label;
  }
  //@+node:caminhante.20210905134447.1: *3* getTabIndex
  public function getTabIndex() {
    return is_null($this->tabindex)? $this->tabindex = ++DefaultFormField::$currentTabindex: $this->tabindex;
  }
  //@+node:caminhante.20210905134458.1: *3* getId
  ...
  //@+node:caminhante.20210905134504.1: *3* validate
  ...
  //@+node:caminhante.20210905134511.1: *3* render
  public function render() {
    ?>
  ...
  //@+node:caminhante.20210905134516.1: *3* renderLabel
...
//@+node:caminhante.20210905134126.1: ** FormFieldHidden
...
//@+node:caminhante.20210905134129.1: ** FormFieldText
...
//@+node:caminhante.20210905134132.1: ** FormFieldPassword
...
//@+node:caminhante.20210905134135.1: ** FormFieldEmail
class FormFieldEmail extends DefaultFormField {
  //@+others
  //@+node:caminhante.20210905134602.1: *3* validate
  public function validate(&$data) {
    $valid = parent::validate($data);
  ...
  //@+node:caminhante.20210905134608.1: *3* renderInput
  public function renderInput() {
    ?>
...
//@+node:caminhante.20210905134140.1: ** FormFieldDate
class FormFieldDate extends DefaultFormField {
  ...
  //@+others
  //@+node:caminhante.20210905134621.1: *3* validate
  public function validate(&$data) {
    $valid = parent::validate($data);
    if ($valid) {
      if (!empty($this->value)) {
  ...
  //@+node:caminhante.20210905134628.1: *3* renderInput
  public function renderInput() {
    ?>
...
//@+node:caminhante.20210905134147.1: ** FormFieldTime
class FormFieldTime extends DefaultFormField {
  //@+others
  //@+node:caminhante.20210905134642.1: *3* validate
  public function validate(&$data) {
    $valid = parent::validate($data);
  ...
  //@+node:caminhante.20210905134649.1: *3* renderInput
  public function renderInput() {
    ?>
...
//@+node:caminhante.20210905134153.1: ** FormFieldNumeric
class FormFieldNumeric extends DefaultFormField {
  ...
  public $maxlength = null;
  //@+others
  //@+node:caminhante.20210905134705.1: *3* validate
  public function validate(&$data) {
    $valid = parent::validate($data);
    if ($valid) {
      if (!empty($this->value)) {
  ...
  //@+node:caminhante.20210905134712.1: *3* renderInput
  public function renderInput() {
    ?>
...
//@+node:caminhante.20210905134157.1: ** FormFieldCheckbox
class FormFieldCheckbox extends DefaultFormField {
  ...
  //@+others
  //@+node:caminhante.20210905134722.1: *3* populate
  public function populate(&$data) {
  ...
  //@+node:caminhante.20210905134727.1: *3* validate
  public function validate(&$data) {
    $valid = parent::validate($data);
  ...
  //@+node:caminhante.20210905134733.1: *3* renderLabel
  public function renderLabel() {
    ?>&nbsp;<?php
  }
  //@+node:caminhante.20210905134740.1: *3* renderInput
  public function renderInput() {
    ?>
...
//@+node:caminhante.20210905134201.1: ** FormFieldTextarea
...
//@+node:caminhante.20210905134204.1: ** FormFieldMultiple
abstract class FormFieldMultiple extends DefaultFormField {
  public $options = array();
  public $multiple = false;
  //@+others
  //@+node:caminhante.20210905134752.1: *3* getName
  public function getName() {
    return $this->name . ($this->multiple? '[]': '');
  }
  //@+node:caminhante.20210905134756.1: *3* populate
  public function populate(&$data) {
  ...
  //@+node:caminhante.20210905134802.1: *3* isSelected
  public function isSelected($key) {
    return ($this->multiple && is_array($this->value))? in_array($key, $this->value): $key == $this->value;
  }
  //@-others
}
//@+node:caminhante.20210905134208.1: ** FormFieldSelect
...
//@+node:caminhante.20210905134212.1: ** FormFieldCheckboxes
...
//@+node:caminhante.20210905134216.1: ** FormFieldRadioButtons
...
//@+node:caminhante.20210905134222.1: ** FormFieldTags
...
//@+node:caminhante.20210905134238.1: ** FormFieldFile
class FormFieldFile extends DefaultFormField {
  ...
  //@+others
  //@+node:caminhante.20210905134827.1: *3* setForm
  ...
  //@+node:caminhante.20210905134836.1: *3* populate
  public function populate(&$data) {
    if (array_key_exists($this->name, $data)) {
      $this->value = $data[$this->name];
    }
  ...
  //@+node:caminhante.20210905134841.1: *3* getName
  public function getName() {
    return $this->name . ($this->multiple? '[]': '');
  }
  //@+node:caminhante.20210905134846.1: *3* createFolder
  protected function createFolder() {
    if (!file_exists($this->folder) || !is_dir($this->folder)) {
      @mkdir($this->folder, 0777, true);
    }
  }
  //@+node:caminhante.20210905134854.1: *3* cleanFileName
  protected function cleanFileName($fileName) {
    return standardize(preg_replace('/[^\w\._]+/', '_', $fileName));
  }
  //@+node:caminhante.20210905134901.1: *3* hasValidFileSize
  ...
  //@+node:caminhante.20210905134907.1: *3* hasValidExtension
  ...
  //@+node:caminhante.20210905134916.1: *3* getUniqueFileName
  ...
  //@+node:caminhante.20210905134928.1: *3* validate
  public function validate(&$data) {
    $valid = parent::validate($data);
    if ($valid) {
      if ($this->required) {
  ...
  //@+node:caminhante.20210905134935.1: *3* renderInput
  public function renderInput() {
    ?>
    <?php if (!empty($this->value)): ?>
  ...
  //@+node:caminhante.20210905134939.1: *3* renderFile
  ...
  //@+node:caminhante.20210905134948.1: *3* renderFileUpload
...
//@+node:caminhante.20210905134243.1: ** FormFieldImage
...
//@+node:caminhante.20210905134301.1: ** FormFieldPlupload
class FormFieldPlupload extends FormFieldFile {
  ...
  //@+others
  //@+node:caminhante.20210905135016.1: *3* __construct
  ...
  //@+node:caminhante.20210905135025.1: *3* getPluploadOptions
  ...
  //@+node:caminhante.20210905135032.1: *3* renderPluploadInit
  ...
  //@+node:caminhante.20210905135042.1: *3* onclick
  ...
  //@+node:caminhante.20210905135050.1: *3* renderPluploadInitListener
  protected function renderPluploadInitListener() {
    ?>
    fileInput.style.display = 'none';
    <?php
  }
  //@+node:caminhante.20210905135056.1: *3* renderPluploadPostInitListener
  ...
  //@+node:caminhante.20210905135104.1: *3* renderPluploadFileItemCreation
  ...
  //@+node:caminhante.20210905135111.1: *3* renderPluploadErrorListener
  ...
  //@+node:caminhante.20210905135119.1: *3* renderPluploadFilesAddedListener
  ...
  //@+node:caminhante.20210905135125.1: *3* renderPluploadQueueChangedListener
  ...
  //@+node:caminhante.20210905135131.1: *3* renderPluploadUploadProgressListener
  ...
  //@+node:caminhante.20210905135139.1: *3* renderPluploadUploadCompleteListener
  ...
  //@+node:caminhante.20210905135150.1: *3* renderPluploadFileUploadedListener
  ...
  //@+node:caminhante.20210905135157.1: *3* renderPluploadRemoveFileListener
...
//@+node:caminhante.20210905134303.1: ** FormFieldPluploadImage
